...
--]]
	...
	local AntiKickFrame = Instance.new("Frame")
	local UICorner_AK = Instance.new("UICorner")
	local AntiKickText = Instance.new("TextLabel")
	local AntiKickButton = Instance.new("TextButton")
	local AntiKickWarna = Instance.new("Frame")
	local UICorner_AKW = Instance.new("UICorner")
	
	local AutoSellFrame = Instance.new("Frame")
	local UICorner_AS = Instance.new("UICorner")
	...
	local UICorner_ASW = Instance.new("UICorner")
	
	local StatsFrame = Instance.new("Frame")
	local UICorner_Stats = Instance.new("UICorner")
	...
	ZayrosFISHIT.Name = CONSTANTS.GUI_NAME
	...
	MinimizeBtn.Position = UDim2.new(0.830729239, 0, 0.0375426635, 0)
	...
	-- Floating Icon Properties
	FloatingIcon.Name = "FloatingIcon"
	FloatingIcon.Parent = ZayrosFISHIT
	FloatingIcon.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
	FloatingIcon.BackgroundTransparency = 0.1
	FloatingIcon.BorderSizePixel = 0
	FloatingIcon.Position = UDim2.new(0.02, 0, 0.45, 0)
	FloatingIcon.Size = UDim2.new(0, 60, 0, 60)
	FloatingIcon.Image = "rbxassetid://136555589792977" -- Same logo as sidebar
	...
	local FloatingTooltip = Instance.new("TextLabel")
	FloatingTooltip.Name = "Tooltip"
	FloatingTooltip.Parent = FloatingIcon
	...
	FloatingTooltip.Position = UDim2.new(1.1, 0, 0, 0)
	FloatingTooltip.Size = UDim2.new(0, 120, 0, 30)
	FloatingTooltip.Font = Enum.Font.SourceSansBold
	FloatingTooltip.Text = "Click to open Zayros FISHIT"
	FloatingTooltip.TextColor3 = Color3.fromRGB(255, 255, 255)
	FloatingTooltip.TextScaled = true
	FloatingTooltip.Visible = false
	FloatingTooltip.ZIndex = 11
	...
	UICorner_Min.CornerRadius = UDim.new(0, 4)
	...
	local gui = playerGui:WaitForChild(CONSTANTS.GUI_NAME)
